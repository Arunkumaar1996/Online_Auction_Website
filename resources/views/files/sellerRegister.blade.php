...
@endif
        <div class="col-md-4 mb-1"><h3>Seller Registration Form</h3></div>
    <form class="row g-3" id="form" action="{{url('sellerform-save')}}" method="post" enctype="multipart/form-data">
    @csrf      
    <div class="col-md-4">
        ...
        <div class="col-md-6">
          ...
          <input type="hidden" name="status" class="form-control" id="status" placeholder="update">
        </div>
        <div class="col-12">
        </div>
