    ...
    <section class="align">
        <div class="left text-white">
            <ul class="nav nav-pills flex-column mb-sm-auto mb-0 align-items-center align-items-sm-start" id="menu">
                <li class="black">
                    <a href="{{url('goldProduct')}}" class="nav-link px-0 align-middle ps-3">
                ...
                <li class="black">
                    <a href="{{url('silverProduct')}}" class="nav-link px-0 align-middle ps-3">
                ...
                <li class="black">
                    <a href="{{url('diamondProduct')}}" class="nav-link px-0 align-middle ps-3">
