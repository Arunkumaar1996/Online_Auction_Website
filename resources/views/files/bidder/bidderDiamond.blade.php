...
<section id="navFlex">
    ...
    <div class="text-center h1">Diamond Products</div>
        ...
        <div class="col text-center">
          <div class="card">
            ...
            <div class="card-body">
              ...
              <div class="card-title fw-bold"><?php $str1=$data->productname;print_r($str1);   ?></div>
              <div class="card-text ">
                <div class="px"><P><?php $str1=$data->description;print_r($str1);   ?></P></div>
